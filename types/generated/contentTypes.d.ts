...
export interface ApiActeurActeur extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Email: Attribute.Email;
    nom_artiste: Attribute.String;
    description: Attribute.Text;
    phone_personel: Attribute.String;
    phone_public: Attribute.String;
    image_profil: Attribute.Media;
    ...
    >;
    sous_categories: Attribute.Relation<
      'api::acteur.acteur',
      'manyToMany',
      'api::sous-categorie.sous-categorie'
    >;
    groupes: Attribute.Relation<
      'api::acteur.acteur',
      'manyToMany',
      'api::groupe.groupe'
    >;
...
export interface ApiGroupeGroupe extends Schema.CollectionType {
  ...
  attributes: {
    nom: Attribute.String;
    date_de_creation: Attribute.String;
    acteurs: Attribute.Relation<
      'api::groupe.groupe',
      'manyToMany',
      'api::acteur.acteur'
    >;
...
export interface ApiSousCategorieSousCategorie extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::acteur.acteur': ApiActeurActeur;
